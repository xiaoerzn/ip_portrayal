<template>
  <div class="body">
    ...
    <!-- 基础信息 -->
    <p><img class="icon" src="../../assets/domainbase.png" />&nbsp;<span class="lable">基础信息</span></p>
    ...
    <el-row :gutter="10">
      ...
      <el-col :span="6">
        <el-tabs type="border-card" stretch class="tabtwo">
          <el-tab-pane label="子域名">
...
import ParsePath from './DomainDetail/ParsePath_v2.vue'
